...
function addItem() {
  ...
  if (itm != "") {
    ...
    chk.addEventListener("click", function () {
      ...
      var confirmNO4 = window.confirm("Are sure , You want to COMPLETE your Task ? :-  " +  this.parentNode.nextSibling.innerHTML);
    ...
    del.addEventListener("click", function () {
      ...
      var confirmNO2 = window.confirm("Are sure , You want to DELETE your Task ? :-  " + this.parentNode.parentNode.firstChild.innerHTML);
      if (confirmNO2) {
    ...
    edt.addEventListener("click", function () {
                                                  ...
                                                  if(window.confirm((el.firstChild).nextSibling.innerHTML + "\n Are you sure you want to edit this?")){   
...
}else{ window.alert("Please don't add NUMBERS!");}

}else{window.alert("Add your Task first!!");}
}
...
function editDoneItem(){
  ...
  if(window.confirm(litm.value + "\nAre you sure the item you are editing is correct?")){ 
